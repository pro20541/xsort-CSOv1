...
class MyGenericTransformer(MyBaseMLModel, TransformerMixin):
    ...
    Args:
        ...
        score_metric (str): Scoring metric to request from main_files (default: "balanced_accuracy").
    ...
    Methods:
        ...
        transform(X): Transform features using the main_files model.
        score(X, y): Score data using main_files metric and options.
    """
    ...
    def __init__(
        ...
        Args:
            db_connection: Active MySQL main_files database connection.
            task: ML task type for transformer.
            score_metric: Requested main_files scoring metric.
    ...
    def transform(
        ...
        Returns:
            pd.DataFrame: Results of transformation as returned by main_files.
    ...
    def score(
        ...
        """
        Score the transformed data using the main_files scoring interface.
        ...
        Returns:
            float: Score based on main_files metric.
